    ...
    <View className="flex-1">
      <LinearGradient colors={['#f8fafc', '#f1f5f9']} className="flex-1">
        <View className="px-6 pt-8 pb-5 bg-card-light dark:bg-card-dark border-b border-border-light dark:border-border-dark">
          ...
          <Text className="text-sm font-medium text-textSecondary-light dark:text-textSecondary-dark">Configure course metadata and content</Text>
        </View>
              ...
              <View className="flex-1">
                ...
                <View className="flex-row px-6 bg-card-light dark:bg-card-dark border-b border-border-light dark:border-border-dark">
                  ...
                  >
                    ...
                    <Text className={`text-sm font-semibold ${activeTab === 'summary' ? 'color-[#667eea]' : 'text-textSecondary-light dark:text-textSecondary-dark'}`}>Summary</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                  ...
                  >
                    ...
                    <Text className={`text-sm font-semibold ${activeTab === 'xml' ? 'color-[#667eea]' : 'text-textSecondary-light dark:text-textSecondary-dark'}`}>XML Editor</Text>
                  </TouchableOpacity>
                </View>
                  ...
                  {activeTab === 'summary' ? (
                    <ScrollView contentContainerStyle={{ padding: 24 }}>
                      <View className="bg-card-light dark:bg-card-dark rounded-2xl p-6 shadow-md shadow-[#000]/5 border border-divider-light dark:border-divider-dark">
                        ...
                        <Text className="text-base text-text-light dark:text-text-dark leading-6 mb-5">{selectedCourseId}</Text>
                        ...
                        <Text className="text-base text-text-light dark:text-text-dark leading-6 mb-5">{summary?.course_name || 'No description available.'}</Text>
                        ...
                        <View className="flex-row gap-8 flex-wrap">
                          ...
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            ...
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.units || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Chapters</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.chapters || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Glossary</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.glossary_terms || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Solved Problems</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.solved_problems || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Topics</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.topics || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Question Bank</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.questions || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Images</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.images || 0}</Text>
                          </View>
                          <View className="flex-[1_1_25%] min-w-[120px]">
                            <Text className="text-xs text-textSecondary-light dark:text-textSecondary-dark mb-1">Videos</Text>
                            <Text className="text-2xl font-bold color-[#667eea]">{summary?.videos || 0}</Text>
                          </View>
                        </View>
                      </View>
                    </ScrollView>
                      ...
                      <View className="p-3 flex-row justify-end border-b border-border-light dark:border-border-dark">
                        <View className="flex-row gap-3">
                          ...
                          >
                            ...
                            <Text className="text-textSecondary-light dark:text-textSecondary-dark text-[13px] font-semibold">Validate</Text>
                          </TouchableOpacity>
                          <TouchableOpacity
                          ...
                          >
                            ...
                            <Text className="color-white text-[13px] font-semibold">Save Changes</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                      <TextInput
                        className="flex-1 p-5 text-sm color-[#334155] bg-[#fafafa]"
                        style={{ fontFamily: 'monospace', textAlignVertical: 'top' }}
                        value={xmlContent}
